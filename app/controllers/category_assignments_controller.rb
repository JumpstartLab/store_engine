  ...
  def create
    ...
    respond_to do |format|
      if @category_assignment.save
        format.html { redirect_to @category_assignment,
                      notice: 'Category assignment was successfully created.' }
        format.json { render json: @category_assignment,
                             status: :created,
                             location: @category_assignment }
      else
        format.html { render action: "new" }
        format.json { render json: @category_assignment.errors,
  ...
  def update
    ...
    respond_to do |format|
      if @category_assignment.update_attributes(params[:category_assignment])
        format.html { redirect_to @category_assignment,
                      notice: 'Category assignment was successfully updated.' }
