  ...
  context "category" do
    ...
    let!(:product_categories) do
      [p_c_one = Fabricate(:product_category, :product_id => 1, :category_id => 1),
       p_c_two = Fabricate(:product_category, :product_id => 2, :category_id => 1),
       p_c_three = Fabricate(:product_category, :product_id => 3, :category_id => 1),
       p_c_four = Fabricate(:product_category, :product_id => 4, :category_id => 1),
       p_c_five = Fabricate(:product_category, :product_id => 1, :category_id => 2),
      ]
    end
