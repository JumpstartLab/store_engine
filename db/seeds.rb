...
p1 = Product.create(title: "Sample Product 1", description: "Lorem ipsum dolor sit amet", category: c1)
p2 = Product.create(title: "Second Product Sample", description: "Foo bar baz quux", category: c2)
