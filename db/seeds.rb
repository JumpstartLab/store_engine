...
User.destroy_all
User.create(full_name: 'Matt Yoho', email_address: 'matt.yoho@livingsocial.com',
            display_name: '', password: 'test')
User.create(full_name: 'Jeff Casimir', email_address: 'jeff.casimir@livingsocial.com',
            display_name: 'j3', password: 'test')
User.create(full_name: 'Chad Fowler', email_address: 'chad.fowler@livingsocial.com',
