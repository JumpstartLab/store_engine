...
table = Product.create(:title => "Great table", :description => "This is the sweetest chair", :price => "10.00", :remote_image_url => "http://ecx.images-amazon.com/images/I/31lRJMSUDOL._SL500_AA300_.jpg")
