...
p1 = Product.create(title: "Sample Product 1", description: "Lorem ipsum dolor sit amet", category_id: c1.id price_in_cents: 1050)
p2 = Product.create(title: "Second Product Sample", description: "Foo bar baz quux", category_id: c2.id, price_in_cents: 19999)
